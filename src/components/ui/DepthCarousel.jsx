        ...
        {data.map((item, i) => (
          ...
          >
            ...
            {onZoom && active === i && (
              <button
                type="button"
                className="depth-carousel__zoom"
                aria-label={`Zoom in on ${item.alt || `slide ${i + 1}`}`}
                onClick={event => {
              ...
              >
                <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
                  <path
                    d="M11 5a6 6 0 1 0 3.87 10.58L19.3 20 20.7 18.6l-4.42-4.43A6 6 0 0 0 11 5Zm0 2a4 4 0 1 1 0 8 4 4 0 0 1 0-8Zm1 1h-2v2H8v2h2v2h2v-2h2v-2h-2V8Z"
                    fill="currentColor"
                  />
                </svg>
                <span>Zoom</span>
